...
const newHTML = `<div id="dock-default-state" class="absolute inset-0 w-full h-full flex items-center justify-between px-7 md:px-9 transition-all duration-[500ms] ease-[cubic-bezier(0.16,1,0.3,1)] opacity-100 transform translate-x-0">
        ...
        <a href="#" id="dock-ai-btn" class="flex flex-col items-center justify-center group cursor-pointer h-full">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 md:w-[26px] md:h-[26px] group-hover:-translate-y-0.5 transition-all duration-300 text-[#71C04C] group-hover:text-[#E12427]" fill="none" viewBox="0 0 24 24" stroke-width="1.4">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
...
if (content.match(regex)) {
    ...
    console.log("Updated hover colors successfully.");
} else {
