...
start_marker = '<!-- Quantity Selector -->'
...
if start_idx != -1 and end_idx != -1:
    new_qty_html = """<!-- Quantity Selector -->
            <div class="flex items-center gap-6 mb-8">
              ...
              <div class="flex items-center gap-4">
                ...
                <!-- Number Box -->
                <div class="w-[70px] h-[40px] flex items-center justify-center font-medium text-[16px] text-[#252525] bg-white border border-gray-300 rounded-[4px] shadow-sm">
                  1
                </div>
