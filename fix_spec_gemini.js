...
// Overwrite the first product (GEMINI 308L) based EXACTLY on what the user provided
db[0] = {
  "id": "gem-308l", // Kept as gem-308l for URL routing
  "name": "ลวดเชื่อมสเตนเลสไฟฟ้า GEMINI 308L (E308L-16)",
  "brand": "GEMINI",
  "category": "ลวดเชื่อมสเตนเลส",
  "sku": "GEM-308L",
  "description": "ลวดเชื่อมเจมินี่ 308L เป็นลวดเชื่อมสเตนเลสออสเทนนิติก สารพอกหุ้มประเภทไทเทเนีย มีธาตุคาร์บอนผสมในปริมาณต่ำ...",
  
  // Kept for breadcrumb support
  "categories": [
...
console.log("Restored exact specsTable array for GEMINI 308L as requested.");
