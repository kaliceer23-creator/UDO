...
const newCol5 = `        <!-- Col 5 -->
        <div class="flex flex-col">
          ...
          <div class="flex items-center gap-3 md:gap-4 mb-8">
            <img src="/images/footer-logos/dbd.png" alt="DBD Registered" class="h-7 md:h-9 w-auto object-contain" />
            <img src="/images/footer-logos/mastercard.png" alt="Mastercard" class="h-5 md:h-7 w-auto object-contain" />
          ...
          <div class="flex items-center gap-2 md:gap-2.5 mb-8 flex-wrap">
            <a href="#" class="hover:opacity-80 transition-opacity"><img src="/images/footer-logos/facebook.webp" alt="Facebook" class="w-10 h-10 md:w-[44px] md:h-[44px] object-contain" /></a>
            <a href="#" class="hover:opacity-80 transition-opacity"><img src="/images/footer-logos/instagram.webp" alt="Instagram" class="w-10 h-10 md:w-[44px] md:h-[44px] object-contain" /></a>
            <a href="#" class="hover:opacity-80 transition-opacity"><img src="/images/footer-logos/line.webp" alt="Line" class="w-10 h-10 md:w-[44px] md:h-[44px] object-contain" /></a>
            <a href="#" class="hover:opacity-80 transition-opacity"><img src="/images/footer-logos/tiktok.webp" alt="TikTok" class="w-10 h-10 md:w-[44px] md:h-[44px] object-contain" /></a>
            <a href="#" class="hover:opacity-80 transition-opacity"><img src="/images/footer-logos/x.webp" alt="X" class="w-10 h-10 md:w-[44px] md:h-[44px] object-contain" /></a>
            <a href="#" class="hover:opacity-80 transition-opacity"><img src="/images/footer-logos/youtube.webp" alt="YouTube" class="w-10 h-10 md:w-[44px] md:h-[44px] object-contain" /></a>
          </div>
          ...
          <div class="flex items-center gap-3 md:gap-4">
            ...
            <img src="/images/footer-logos/dhl.webp" alt="DHL" class="h-[18px] md:h-5 w-auto object-contain" />
            <img src="/images/footer-logos/thai-post.png" alt="Thailand Post" class="h-6 md:h-[28px] w-auto object-contain" />
          </div>
        </div>`;
...
if (content.includes(oldCol5)) {
    ...
    console.log("Scaled down icons to the medium goldilocks zone.");
} else {
